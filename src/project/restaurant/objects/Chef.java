...
public class Chef extends Staff {
    ...
    // TODO when quantity of products gets low, make order
    public boolean canCook(String order, Storage storage) { // Metodi.T
        switch (order) {
...
//                        storage.availableProducts.computeIfPresent("Домати", (k, v) -> v + 10.0);
//                    }
...
//                        storage.availableProducts.computeIfPresent("Телешко месо", (k, v) -> v + 5.0);
//                    }
//                    if (storage.availableProducts.get("Готварска сметана") < 0.300) {
//                        System.out.println("Прави се заявка за готварска сметана!");
//                        storage.availableProducts.computeIfPresent("Готварска сметана", (k, v) -> v + 10.0);
//                    }
//                    if (storage.availableProducts.get("Гъби") < 0.300) {
//                        System.out.println("Прави се заявка за гъби!");
//                        storage.availableProducts.computeIfPresent("Гъби", (k, v) -> v + 10.0);
//                    }
                    return false;
                }
                break;
            case "Свинска вратна пържола с картофи по селски":
                if (storage.getAvailableProducts().get("Свинско месо") >= 0.300 && storage.availableProducts.get("Картофи") >= 0.250) {
...
//                        storage.availableProducts.computeIfPresent("Свинско месо", (k, v) -> v + 10.0);
//                    }
//                    if (storage.availableProducts.get("Картофи") < 0.300) {
//                        System.out.println("Прави се заявка за картофи!");
//                        storage.availableProducts.computeIfPresent("Картофи", (k, v) -> v + 10.0);
//                    }
                    return false;
                }
                break;
...
//                        storage.availableProducts.computeIfPresent("Пилешко месо", (k, v) -> v + 5.0);
//                    }
//                    if (storage.availableProducts.get("Червени пиперки") < 0.300) {
//                        System.out.println("Прави се заявка за червени пиперки!");
//                        storage.availableProducts.computeIfPresent("Червени пиперки", (k, v) -> v + 10.0);
...
//                        storage.availableProducts.computeIfPresent("Колекция сирена", (k, v) -> v + 10.0);
//                    }
                    return false;
                }
                break;
...
//                        storage.availableProducts.computeIfPresent("Еклерова торта", (k, v) -> v + 8.0);
//                    }
                    return false;
                }
                break;
...
//                        storage.availableProducts.computeIfPresent("Шоколадово суфле", (k, v) -> v + 8.0);
//                    }
                    return false;
                }
                break;
...
//                        storage.availableProducts.computeIfPresent("Тесто", (k, v) -> v + 10.0);
//                    }
//                    if (storage.availableProducts.get("Течен шоколад") < 0.300) {
//                        System.out.println("Прави се заявка за течен шоколад!");
//                        storage.availableProducts.computeIfPresent("Течен шоколад", (k, v) -> v + 10.0);
//                    }
                    return false;
                }
                break;
...
//                        storage.availableProducts.computeIfPresent("Бяло вино - Еленово Шардоне", (k, v) -> v + 20.0);
//                    }
                    return false;
                }
                break;
            case "Червено вино - Еленово Каберне Совиньон":
                if (storage.getAvailableProducts().get("Червено вино - Еленово Каберне Совиньон") >= 0.300) {
                    storage.availableProducts.computeIfPresent("Червено вино - Еленово Каберне Совиньон", (k, v) -> v - 0.300);
                } else {
//                    if (storage.getAvailableProducts().get("Червено вино - Еленово Каберне Совиньон") <= 0.300) {
//                        System.out.println("Прави се заявка за червено вино - Еленово Каберне Совиньон!");
//                        storage.availableProducts.computeIfPresent("Червено вино - Еленово Каберне Совиньон", (k, v) -> v + 20.0);
//                    }
                    return false;
                }
                break;
...
//                        storage.availableProducts.computeIfPresent("Росиди Розе де Пино", (k, v) -> v + 20.0);
//                    }
                    return false;
                }
                break;
...
//                        storage.availableProducts.computeIfPresent("Уиски Glenfiddich", (k, v) -> v + 20.0);
//                    }
//                    return false;
                }
                break;
...
//                        storage.availableProducts.computeIfPresent("Уиски Jameson", (k, v) -> v + 20.0);
//                    }
                    return false;
                }
                break;
...
//                        storage.availableProducts.computeIfPresent("Бира Heineken", (k, v) -> v + 100.0);
//                    }
                    return false;
                }
                break;
...
//                        storage.availableProducts.computeIfPresent("Бира Starobrno", (k, v) -> v + 100.0);
//                    }
                    return false;
                }
                break;
...
//                        storage.availableProducts.computeIfPresent("Кока Кола", (k, v) -> v + 100.0);
//                    }
                    return false;
                }
                break;
...
//                        storage.availableProducts.computeIfPresent("Студен чай", (k, v) -> v + 100.0);
//                    }
                    return false;
                }
                break;
...
//                        storage.availableProducts.computeIfPresent("Минерална вода", (k, v) -> v + 100.0);
//                    }
                    return false;
                }
                break;
