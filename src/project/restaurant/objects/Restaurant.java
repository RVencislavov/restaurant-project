...
public class Restaurant implements ColorAble {
   ...
   */
    ...
    public void work() {
            ...
            while (clientIterator.hasNext()) {
                ...
                if (isRestaurantIsFull()) {
                    System.out.println("Ресторантът е пълен, ако желаете, можете да изчакате да се освободи маса.");
                ...
                for (Table table : getTables()) {
                    ...
                    getHostesses().get(generateRandomNumber(0, generateHostesses().size()))
    ...
    public void preparingForTheNewDay() {

        setRestaurantIsFull(false);
        for (Table table : getTables()) {
            table.setTableIsFree(true);
            setRestaurantTableCapacity(15);
        }
    ...
    public void newDay(){
        ...
        while (choice != 0) {
            if (choice == 1) {
                ...
                try {
                    System.out.println(ANSI_RED + "Моля въведете коректен избор!" + ANSI_RESET);
                    choice = Integer.parseInt(scanner.nextLine());
                } catch (NumberFormatException ex) {
                    System.err.println(ANSI_RED + "Моля въведете коректен избор!" + ANSI_RESET);
                    choice = Integer.parseInt(scanner.nextLine());
                }
            }
        }
    ...
    public Map<String, Double> generateStorage() {
        ...
        products.put("Риба тон", 50.0);
        products.put("Гъби", 30.0);
        products.put("Картофи", 30.0);
        products.put("Червени пиперки", 30.0);
        products.put("Моркови", 30.0);
        products.put("Тиквички", 30.0);
        products.put("Домати", 30.0);
        products.put("Чери домати", 30.0);
        products.put("Краставици", 30.0);
        products.put("Айсберг", 30.0);
        products.put("Царевица", 30.0);
        products.put("Червен лук", 30.0);
        products.put("Лук", 30.0);
        products.put("Маслини", 30.0);
        products.put("Сирене", 30.0);
        products.put("Моцарела", 30.0);
        products.put("Колекция сирена", 30.0);
        products.put("Готварска сметана", 30.0);
        products.put("Тесто", 30.0);
        products.put("Течен шоколад", 30.0);
        products.put("Еклерова торта", 30.0);
        products.put("Шоколадово суфле", 30.0);
        products.put("Бяло вино - Еленово Шардоне", 50.0);
        products.put("Червено вино - Еленово Каберне Совиньон", 50.0);
        products.put("Росиди Розе де Пино", 50.0);
        products.put("Уиски Glenfiddich", 50.0);
        products.put("Уиски Jameson", 50.0);
    ...
    public static int generateRandomNumber(int min, int max) {          //Nikolai S.
